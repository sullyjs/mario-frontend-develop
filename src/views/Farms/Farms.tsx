...
const Farms: React.FC = () => {
  ...
  const activeFarms = farmsLP.filter((farm) => farm.pid !== 0 && farm.pid !== 14 && farm.multiplier !== '0X')
  ...
  return (
    <>
      ...
      <Page>
        ...
        {renderContent()}
        <StyledImage src="/images/3dmario.png" alt="Mario illustration" width={120} height={103} />
      </Page>
    </>
  )
}
