...
const LotteryJackpot = () => {
  ...
  const lotteryPrizeAmoutShroom = balance.toLocaleString(undefined, {
    maximumFractionDigits: 2,
  })
  const lotteryPrizeAmountBusd = new BigNumber(balance).multipliedBy(usePriceShroomBusd()).toNumber()

  return (
    <>
      <Text bold fontSize="24px" style={{ lineHeight: '1.5' }}>
        {lotteryPrizeAmoutShroom} {TranslateString(999, 'SHROOM')}
      </Text>
