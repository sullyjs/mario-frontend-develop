...
interface ApproveMushroomPageProps extends InjectedModalProps {
  goToChange: UseEditProfileResponse['goToChange']
}

const ApproveMushroomPage: React.FC<ApproveMushroomPageProps> = ({ goToChange, onDismiss }) => {
  ...
  return (
    <Flex flexDirection="column">
      <Flex alignItems="center" justifyContent="space-between" mb="24px">
        ...
        <Text>{TranslateString(999, `${getFullDisplayBalance(cost)} MUSHROOM`)}</Text>
      </Flex>
      <Button
...
export default ApproveMushroomPage
