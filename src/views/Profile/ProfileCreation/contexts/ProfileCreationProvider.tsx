...
import { getToadFactoryContract } from 'utils/contractHelpers'
...
const ProfileCreationProvider: React.FC = ({ children }) => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      const toadFactoryContract = getToadFactoryContract()
      const canMint = await toadFactoryContract.methods.canMint(account).call()
