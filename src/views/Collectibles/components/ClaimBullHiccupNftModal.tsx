...
import { Modal, Text, Button, Flex, InjectedModalProps } from '@marioswap-libs/uikit'
...
const bullNft = nftList.find((nft) => nft.toadId === BULL_NFT)
const hiccupNft = nftList.find((nft) => nft.toadId === HICCUP_NFT)
