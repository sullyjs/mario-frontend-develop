...
import { useToadSpecialContract } from 'hooks/useContract'
import { useToast } from 'state/hooks'
import { Button, InjectedModalProps, Modal, Text, Flex } from '@marioswap-libs/uikit'
...
const ClaimNftModal: React.FC<ClaimNftModalProps> = ({ nft, onSuccess, onDismiss }) => {
  ...
  const toadSpecialContract = useToadSpecialContract()

  const handleConfirm = async () => {
    toadSpecialContract.methods
      .mintNFT(nft.toadId)
      .send({ from: account })
      .on('sending', () => {
