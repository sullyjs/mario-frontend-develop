...
import { Heading, CardBody, CardFooter, MarioRoundIcon, TicketRound } from '@marioswap-libs/uikit'
      ...
      <>
        <CardBody>
          <CardHeading>
            ...
            <LotteryCardHeading
              valueToDisplay={TranslateString(999, `${poolSize.toLocaleString()} MUSHROOM`)}
              Icon={MarioRoundIcon}
            >
