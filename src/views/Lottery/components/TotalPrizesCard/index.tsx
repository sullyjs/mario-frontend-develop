...
import { Heading, Card, CardBody, CardFooter, Text, MarioRoundIcon, Flex, Skeleton } from '@marioswap-libs/uikit'
        ...
        <CardHeading>
          <Left>
            ...
            <PrizeCountWrapper>
              ...
              <Heading size="lg">{lotteryPrizeWithCommaSeparators} MUSHROOM</Heading>
            </PrizeCountWrapper>
          </Left>
          <Right>
